 ...
 *
 *=========================================================================*/
#ifndef itkMaskedLabelOverlapMeasuresImageFilter_hxx
#define itkMaskedLabelOverlapMeasuresImageFilter_hxx
...
template<typename TLabelImage, typename TMaskImage>
MaskedLabelOverlapMeasuresImageFilter<TLabelImage, TMaskImage>
::MaskedLabelOverlapMeasuresImageFilter()
{
  ...
  this->m_InsidePixelValue = NumericTraits< MaskImagePixelType >::OneValue();
}
                        ...
                        ThreadIdType threadId )
{
  ...
  for( itS.GoToBegin(), itT.GoToBegin(), itM.GoToBegin(); !itS.IsAtEnd(); ++itS, ++itT, ++itM )
    {
    if(itM.Get() == m_InsidePixelValue)
      {
 ...
 */
template<typename TLabelImage, typename TMaskImage>
typename MaskedLabelOverlapMeasuresImageFilter<TLabelImage, TMaskImage>::RealType
MaskedLabelOverlapMeasuresImageFilter<TLabelImage, TMaskImage>
::GetTotalOverlap()
{
